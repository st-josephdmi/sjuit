              ...
              <form action="patient_details.php" method="GET">
                  <div class="form-group">
                    <label for="uname1">Patient Id</label> 
										<input class="form-control" id="uname1" name="p_id" required="" value="<?php  echo $patient_id;  ?>" type="text" readonly>
                  </div>
                 
                  <div class="form-group">
                    <label for="uname1">Select date</label> 
										<input class="form-control" id="uname1" name="date" required="" value="<?php  echo $datee;  ?>"type="date" readonly>
                  </div>
